 ...
 * Original: email_settings.php (IonCube Protected)
 * Context: enduser
 * Purpose: email
...
/**
 * User Management Class: UserEmailsettings
 * Purpose: email
...
try {
    ...
    $user = new UserEmailsettings($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in email_settings: ' . $e->getMessage());
