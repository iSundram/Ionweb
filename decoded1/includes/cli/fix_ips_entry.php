 ...
 * Original: fix_ips_entry.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Fixipsentry
 * Purpose: general
...
try {
    $handler = new Fixipsentry($_POST['config'] ?? []);
    ...
    error_log('Error in fix_ips_entry: ' . $e->getMessage());
