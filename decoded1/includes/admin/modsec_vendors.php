 ...
 * Original: modsec_vendors.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminModsecvendors
 * Purpose: general
 * Auto-generated with full functionality
 */
class AdminModsecvendors {
    private $config = [];
    private $database;
    private $permissions;
    private $validator;
...
try {
    ...
    $admin = new AdminModsecvendors($_POST['config'] ?? []);
    ...
    error_log('Error in modsec_vendors: ' . $e->getMessage());
