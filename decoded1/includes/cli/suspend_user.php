 ...
 * Original: suspend_user.php (IonCube Protected)
 * Context: include
...
/**
 * General Purpose Class: Suspenduser
 * Purpose: user_management
...
try {
    $handler = new Suspenduser($_POST['config'] ?? []);
    ...
    error_log('Error in suspend_user: ' . $e->getMessage());
