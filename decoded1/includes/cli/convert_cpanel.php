 ...
 * Original: convert_cpanel.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Convertcpanel
 * Purpose: general
...
try {
    $handler = new Convertcpanel($_POST['config'] ?? []);
    ...
    error_log('Error in convert_cpanel: ' . $e->getMessage());
