 ...
 * Original: enduser-api.php (IonCube Protected)
 * Context: include
...
/**
 * General Purpose Class: Enduserapi
 * Purpose: user_management
...
try {
    $handler = new Enduserapi($_POST['config'] ?? []);
    ...
    error_log('Error in enduser-api: ' . $e->getMessage());
