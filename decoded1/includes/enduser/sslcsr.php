 ...
 * Original: sslcsr.php (IonCube Protected)
 * Context: enduser
 * Purpose: ssl
...
/**
 * User Management Class: UserSslcsr
 * Purpose: ssl
...
try {
    ...
    $user = new UserSslcsr($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sslcsr: ' . $e->getMessage());
