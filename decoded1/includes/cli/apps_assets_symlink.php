 ...
 * Original: apps_assets_symlink.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Appsassetssymlink
 * Purpose: general
 * Auto-generated with intelligent functionality
 */
class Appsassetssymlink {
    private $config = [];
...
try {
    $handler = new Appsassetssymlink($_POST['config'] ?? []);
    ...
    error_log('Error in apps_assets_symlink: ' . $e->getMessage());
