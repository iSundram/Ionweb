 ...
 * Original: sel_full_files.php (IonCube Protected)
 * Context: enduser
...
/**
 * User Management Class: UserSelfullfiles
 * Purpose: file_management
 * Auto-generated with full functionality
 */
class UserSelfullfiles {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserSelfullfiles($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sel_full_files: ' . $e->getMessage());
