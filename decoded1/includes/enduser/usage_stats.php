 ...
 * Original: usage_stats.php (IonCube Protected)
 * Context: enduser
 * Purpose: statistics
...
/**
 * User Management Class: UserUsagestats
 * Purpose: statistics
...
class UserUsagestats {
    ...
    // Generic methods for statistics
    // Common user methods
}
...
try {
    ...
    $user = new UserUsagestats($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in usage_stats: ' . $e->getMessage());
