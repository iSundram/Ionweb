 ...
 * Original: user_logs.php (IonCube Protected)
 * Context: enduser
...
/**
 * User Management Class: UserUserlogs
 * Purpose: user_management
...
try {
    ...
    $user = new UserUserlogs($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in user_logs: ' . $e->getMessage());
