...
*/
public static function YAMLLoad() {
}
...
*/
public static function YAMLLoadString() {
}
...
}") !== false) || strpos($value,"&") !== false || strpos($value, "'") !== false || strpos($value, "!") === 0 ||
substr ($value, -1, 1) == ':')
) {
...
private function loadFromSource() {
}
...
private function clearBiggerPathValues() {
}
return true;
}
...
private function isHashElement() {
}
private function isLiteral() {
}
