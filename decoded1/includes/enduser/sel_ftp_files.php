 ...
 * Original: sel_ftp_files.php (IonCube Protected)
 * Context: enduser
...
/**
 * User Management Class: UserSelftpfiles
 * Purpose: file_management
 * Auto-generated with full functionality
 */
class UserSelftpfiles {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserSelftpfiles($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sel_ftp_files: ' . $e->getMessage());
