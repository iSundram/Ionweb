...
$l['strt_backup'] = 'Starting the $type Backup process for the account $usr';
$l['success_backup'] = '$type Backup process completed for the account $usr';
...
$l['err_max_backups_reached'] = 'You have reached the maximum number of backups allowed. Please delete unwanted backups';
$l['err_max_backups_local'] = 'You have reached the maximum number of Local backups allowed. Please delete unwanted backups';
...
$l['cant_restore_dbuser'] = 'Failed to restore database user';
$l['cant_restore_db'] = 'Failed to restore database';
$l['backup_started'] = 'Backup started for the account <b>$usr</b>';
$l['err_create_backup'] = 'There were some errors while creating the backup for the account <b>$usr</b>';
$l['backup_failed'] = '<b>$type</b> Backup failed for the account <b>$usr</b>';
...
$l['delete_backup'] = 'Deleting auto backup';
$l['no_email_account'] = 'No email account found';
$l['error_tmp_user'] = 'Unable to create temporary MYSQL user';
$l['dump_failed'] = 'Unable to dump databases';
$l['fetch_cert_failed'] = 'Unable to find certs';
$l['cert_install_failed'] = 'Unable to install certs';
$l['domain_add_failed'] = 'Unable to add domain';
$l['install_certs'] = 'Installing certificate';
$l['adding_domain'] = 'Adding domain';
$l['remote_fetch_failed'] = 'Unable to fetch remote file';
$l['email_add_failed'] = 'Unable to add email user';
$l['no_dbs'] = 'No database found';
$l['wb_no_users'] = 'No User given';
...
$l['migrate_finished_user'] = 'Migration completed for user';
$l['migrate_conf_finish'] = 'Finished migrating webuzo configurations.';
$l['migrate_conf_failed'] = 'Failed migrating <b>CONFIGS</b>';
$l['migrate_plans_finish'] = 'Finished migrating Webuzo plans';
$l['migrate_plans_failed'] = 'Failed migrating <b>PLANS</b>';
$l['migrate_user_account_finish'] = 'Finished migrating user accounts.';
$l['migrate_home_finish'] = 'Finished migrating <b>HOME</b> data for the user.';
$l['migrate_home_failed'] = 'Failed migrating <b>HOME</b> data for the user.';
$l['migrate_emails_finish'] = 'Finished migrating <b>EMAIL</b> accounts and <b>EMAIL</b> data for the user';
$l['migrate_emails_failed'] = 'Failed migrating <b>EMAIL</b> data for the user.';
$l['migrate_databases_finish'] = 'Finished migrating databases for the user';
$l['migrate_databases_failed'] = 'Failed migrating databases for the user';
$l['no_remote_dbs_found'] = 'No database found on the remote server for the user';
$l['dont_import_dbuser'] = 'Unable to import database user';
$l['dont_import_db'] = 'Unable to import database';
$l['default_dbuser_exist'] = 'Default database user already exist, hence we can\'t proceed database import for this account';
$l['user_exist'] = 'User already exist, if you want to migrate this user then please select overwrite option while importing';
$l['migrate_incomplete_user'] = 'Migration was incompletely done for user';
$l['sshpass_install_failed'] = 'There are some issue in installing <b>ssshpass</b> package, Hence can\'t proceed import';

$l['migrate_ftp_finish'] = 'Finished migrating FTP.';
$l['mysql_not_same'] = 'MySQL version on the local server is not the same as remote server';
...
$l['migrate_conf_failed'] = 'Unable to migrate configuration';
$l['conn_fail'] = 'Connection to Webuzo server failed.';
$l['no_migration'] = 'The server from where you are importing is an older Webuzo version (older than 3.0.0). Please update the server and then try !';
$l['no_db_dump'] = 'Database dump file not found on the local server for the user';
...
$l['pe_invalid_action'] = 'Action Invalid';

// cPanel import
$l['db_added_success'] = 'Databases added successfully';
$l['dbuser_added_success'] = 'Databases Users added successfully';
$l['dont_import_db'] = 'Unable to import database';
$l['dont_import_dbuser'] = 'Unable to import database user';
$l['db_import_success'] = 'Databases imported successfully';
$l['db_import_failed'] = 'Databases imported failed';
$l['cpanel_pass_or_file'] = 'Specify either cPanel password or backup file name';
$l['filename_pass_not_allowed'] = 'You can not specify cPanel password and backup file name';
$l['init_backup'] = 'Initializing Backup from cPanel';
$l['cant_connect_cpanel'] = 'Could not connect to cPanel -';
$l['exit_script'] = 'Exiting the script';
$l['backuplist_not_found'] = 'Backup list not found -';
$l['backup_extract'] = 'Extracting the backup file';
$l['no_file_found'] = 'No file with the given name found';
$l['incorrect_file_format'] = 'Incorrect File format found';
$l['no_backup_file'] = 'No backup file to import';
$l['homedir_copied'] = 'Homedir copied successfully';
$l['migration_success'] = 'Migration completed successfully';
$l['ci_tar_extract_failed'] = 'Failed to extract the backup tar file';
$l['homedir_copied_failed'] = 'Copying homedir failed';
$l['copying_files'] = 'Copying homedir from backup';
$l['no_user'] = 'No user found';

// cPanel convert
$l['conversion_success'] = 'Conversion completed successfully';

// email_all
$l['ea_success_log'] = 'Email sent successfully to';
$l['ea_error'] = 'There was an error while sending the Email to';

// Rearrange account
$l['rac_user_missing'] = 'User Missing';
$l['rac_storage_missing'] = 'Storage Missing';
$l['rac_start'] = 'Started Rearranging for account <b>$usr</b><br>Calculating disk space and inodes needed …';
$l['rac_err_wrong'] = 'Error: Something went wrong !';
$l['rac_avail'] = 'Target <b>$dest_path</b> on host <b>$pri_dom</b> has $dest_free_kb KB free and requires at least $usr_req_kb KB free.<br> Target <b>$dest_path</b> on host <b>$pri_dom</b> has $dest_free_inodes inodes free and requires at least $usr_req_in inodes free.';
$l['rac_err_avail'] = 'Error: Required storage space or inodes is not available on the destination storage';
$l['rac_move'] = 'The system will move <b>$src_path</b> to <b>$dest_path</b>.';
$l['rac_err_move'] = 'Error: The file transfer failed';
$l['rac_move_succ'] = 'The file transfer succeeded.<br>The system will update the file <b>/etc/passwd</b>';
$l['rac_err_passwd'] = 'Error: Unable to update <b>/etc/passwd</b> file.';
$l['rac_passwd_done'] = 'Successfully updated <b>/etc/passwd</b> file.';
$l['rac_sym'] = 'The system will symlink <b>$src_path</b> to <b>$dest_path</b>.';
$l['rac_update_user'] = 'User information updated successfully.';
$l['rac_post_ops'] = 'The system will rebuild the PHP-FPM configuration files.<br>The system will update the file pureftpd.passwd';
$l['rac_success'] = 'The rearrangement of home directories on the account is complete.<br>Success.';

// Install Distro packages
$l['dp_inv_act'] = 'Invalid Action';
$l['dp_inv_package'] = 'Invalid Package Name';

//Delete user
$l['no_user_exist'] = 'User does not exist';
$l['error_del_user'] = 'There were some error while deleting user';
$l['success_del_user'] = 'User deleted successfully';

// Domain info
$l['no_domain'] = 'No domain found';
$l['no_dom_exist'] = 'Domain does not exist';

// Change quota and plans
$l['rp_qu_in'] = 'Updating quota and inodes for the user <b>$usr</b>';
$l['rp_qu_in_succ'] = 'Quota and Inodes of users updated successfully.';
$l['rp_no_plan'] = 'No Plan found!';

// Delete emails
$l['de_no_email'] = 'No email found';
$l['de_def_email'] = 'Default email <b>$email</b> cannot be deleted.';
$l['de_un_email'] = 'Unable to delete email <b>$email</b>';
$l['de_err_noexist'] = 'The Email ID does not exist !';
$l['de_succ_email'] = 'Email <b>$email</b> deleted successfully.';
