 ...
 * Original: terminal.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserTerminal
 * Purpose: general
...
try {
    ...
    $user = new UserTerminal($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in terminal: ' . $e->getMessage());
