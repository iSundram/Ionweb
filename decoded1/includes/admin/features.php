 ...
 * Original: features.php (IonCube Protected)
 * Context: admin
 * Purpose: features
...
/**
 * Admin Management Class: AdminFeatures
 * Purpose: features
...
try {
    ...
    $admin = new AdminFeatures($_POST['config'] ?? []);
    ...
    error_log('Error in features: ' . $e->getMessage());
