...
function rearrange_categories_theme(){
	...
	global $user, $globals, $theme, $softpanel, $error, $done, $langs, $plans, $tags, $plan_fields, $planval, $SESS, $icons, $enduser_categories, $WE;

	softheader(__('Rearrange Categories'));
