 ...
 * Original: redirects.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserRedirects
 * Purpose: general
...
try {
    ...
    $user = new UserRedirects($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in redirects: ' . $e->getMessage());
