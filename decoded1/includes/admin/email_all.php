 ...
 * Original: email_all.php (IonCube Protected)
 * Context: admin
 * Purpose: email
...
/**
 * Admin Management Class: AdminEmailall
 * Purpose: email
...
try {
    ...
    $admin = new AdminEmailall($_POST['config'] ?? []);
    ...
    error_log('Error in email_all: ' . $e->getMessage());
