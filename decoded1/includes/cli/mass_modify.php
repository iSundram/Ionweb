 ...
 * Original: mass_modify.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Massmodify
 * Purpose: general
...
try {
    $handler = new Massmodify($_POST['config'] ?? []);
    ...
    error_log('Error in mass_modify: ' . $e->getMessage());
