 ...
 * Original: mail_functions.php (IonCube Protected)
 * Context: include
 * Purpose: email
...
/**
 * General Purpose Class: Mailfunctions
 * Purpose: email
...
try {
    $handler = new Mailfunctions($_POST['config'] ?? []);
    ...
    error_log('Error in mail_functions: ' . $e->getMessage());
