...
global $theme, $globals, $kernel, $user, $error, $done, $onboot, $user_name, $iapps, $isql, $softpanel, $WE, $app2fa;
	
	//r_print($user['2fa']['method']);
...
<div class="card soft-card p-4 col-12 col-lg-10 mx-auto">
	<div class="sai_main_head">
		<i class="fas fa-user-shield fa-2x webu_head_img me-2"></i>
		<h5 class="d-inline-block">'.__('Two-Factor Authentication').'</h5>
	</div>
</div>
<div class="card soft-card p-4 col-12 col-lg-10 mx-auto mt-4">
	<form accept-charset="'.$globals['charset'].'" action="" method="post" name="configure2fa" id="configure2fa" class="form-horizontal">';
