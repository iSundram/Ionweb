...
function extra_conf_theme(){
	...
	global $user, $globals, $theme, $softpanel, $WE, $error, $done, $domain_list, $file_list, $domain_name, $iapps, $w_list;
	
	if(!empty($done)){
		$file_list = $WE->read_extra_conf($domain_name);
	}
...
function showconf(){
	...
	global $globals, $softpanel, $WE, $error, $file_list, $domain_name, $theme, $w_list;
			
	if(!is_array($file_list)){		
	   //echo 'NO RECORD FOUND!!!';
	   echo '<div class="row">
				<div class="sai_notice">'.__('No records Found').'</div>
			</div>';
	}else{
		echo '
