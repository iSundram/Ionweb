 ...
 * Original: bind_modify_dns.php (IonCube Protected)
 * Context: include
 * Purpose: dns
...
/**
 * General Purpose Class: Bindmodifydns
 * Purpose: dns
...
try {
    $handler = new Bindmodifydns($_POST['config'] ?? []);
    ...
    error_log('Error in bind_modify_dns: ' . $e->getMessage());
