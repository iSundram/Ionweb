 ...
 * Original: mxentry.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserMxentry
 * Purpose: general
...
try {
    ...
    $user = new UserMxentry($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in mxentry: ' . $e->getMessage());
