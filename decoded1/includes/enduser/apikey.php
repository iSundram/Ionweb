 ...
 * Original: apikey.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserApikey
 * Purpose: general
...
try {
    ...
    $user = new UserApikey($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in apikey: ' . $e->getMessage());
