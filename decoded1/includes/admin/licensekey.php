 ...
 * Original: licensekey.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminLicensekey
 * Purpose: general
...
try {
    ...
    $admin = new AdminLicensekey($_POST['config'] ?? []);
    ...
    error_log('Error in licensekey: ' . $e->getMessage());
