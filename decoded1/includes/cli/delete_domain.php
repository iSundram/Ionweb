 ...
 * Original: delete_domain.php (IonCube Protected)
 * Context: include
 * Purpose: domains
...
/**
 * General Purpose Class: Deletedomain
 * Purpose: domains
...
try {
    $handler = new Deletedomain($_POST['config'] ?? []);
    ...
    error_log('Error in delete_domain: ' . $e->getMessage());
