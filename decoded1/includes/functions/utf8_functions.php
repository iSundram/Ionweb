 ...
 * Original: utf8_functions.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Utf8functions
 * Purpose: general
...
try {
    $handler = new Utf8functions($_POST['config'] ?? []);
    ...
    error_log('Error in utf8_functions: ' . $e->getMessage());
