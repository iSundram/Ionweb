 ...
 * Original: add_all_os_ips.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Addallosips
 * Purpose: general
...
try {
    $handler = new Addallosips($_POST['config'] ?? []);
    ...
    error_log('Error in add_all_os_ips: ' . $e->getMessage());
