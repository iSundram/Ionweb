 ...
 * Original: service-monitor.php (IonCube Protected)
 * Context: include
 * Purpose: monitoring
...
/**
 * General Purpose Class: Servicemonitor
 * Purpose: monitoring
...
try {
    $handler = new Servicemonitor($_POST['config'] ?? []);
    ...
    error_log('Error in service-monitor: ' . $e->getMessage());
