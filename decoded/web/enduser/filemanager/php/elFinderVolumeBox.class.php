...
* @return array
*/
protected function _bd_splitPath() {
} else {
...
*                    state is not set
*/
protected function _bd_obtainAccessToken() {
}
...
* @throws Exception
*/
protected function _bd_getRawItem() {
}
...
**/
protected function _bd_parseRaw() {
}
if ($raw->type === 'folder') {
$stat['mime'] = 'directory';
$stat['size'] = 0;
...
*/
protected function _bd_getThumbnail() {
} catch (Exception $e) {
return false;
}
}
...
* @author Naoki Sawada
**/
protected function getSharedWebContentLink() {
