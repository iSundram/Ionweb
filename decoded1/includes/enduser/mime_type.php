 ...
 * Original: mime_type.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserMimetype
 * Purpose: general
...
try {
    ...
    $user = new UserMimetype($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in mime_type: ' . $e->getMessage());
