 ...
 * Original: ipblock.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserIpblock
 * Purpose: general
...
try {
    ...
    $user = new UserIpblock($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in ipblock: ' . $e->getMessage());
