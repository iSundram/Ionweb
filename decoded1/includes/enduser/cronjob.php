 ...
 * Original: cronjob.php (IonCube Protected)
 * Context: enduser
 * Purpose: cron
...
/**
 * User Management Class: UserCronjob
 * Purpose: cron
...
try {
    ...
    $user = new UserCronjob($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in cronjob: ' . $e->getMessage());
