 ...
 * Original: add_custom_ports.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Addcustomports
 * Purpose: general
 * Auto-generated with intelligent functionality
 */
class Addcustomports {
    private $config = [];
...
try {
    $handler = new Addcustomports($_POST['config'] ?? []);
    ...
    error_log('Error in add_custom_ports: ' . $e->getMessage());
