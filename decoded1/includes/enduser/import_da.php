 ...
 * Original: import_da.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserImportda
 * Purpose: general
...
try {
    ...
    $user = new UserImportda($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in import_da: ' . $e->getMessage());
