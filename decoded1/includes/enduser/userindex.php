 ...
 * Original: userindex.php (IonCube Protected)
 * Context: enduser
...
/**
 * User Management Class: UserUserindex
 * Purpose: user_management
...
try {
    ...
    $user = new UserUserindex($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in userindex: ' . $e->getMessage());
