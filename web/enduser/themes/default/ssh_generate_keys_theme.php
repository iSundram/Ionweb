...
function ssh_generate_keys_theme(){
	...
	global $user, $globals, $theme, $softpanel, $WE, $error, $keytype, $keysize, $fingerprint, $done;
...
<div class="card soft-card p-4 col-12 mt-4">
	...
	<form accept-charset="'.$globals['charset'].'" action="" method="post" id="ssh_generatekey" class="form-horizontal" onsubmit="return submitit(this)" data-doneredirect="'.$globals['index'].'act=ssh_access">
		<div class="row">
			<div class="col-sm-5">
		...
		<center>
			<input type="submit" class="flat-butt me-2" value="'.__('Generate Key').'" name="generatekey" id="generatekey" />
		</center>
	</form>	
</div>
';	
