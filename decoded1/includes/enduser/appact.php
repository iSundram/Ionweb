 ...
 * Original: appact.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserAppact
 * Purpose: general
...
try {
    ...
    $user = new UserAppact($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in appact: ' . $e->getMessage());
