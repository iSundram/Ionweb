 ...
 * Original: eapps_add.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserEappsadd
 * Purpose: general
...
try {
    ...
    $user = new UserEappsadd($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in eapps_add: ' . $e->getMessage());
