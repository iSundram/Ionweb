 ...
 * Original: eapps.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserEapps
 * Purpose: general
...
try {
    ...
    $user = new UserEapps($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in eapps: ' . $e->getMessage());
