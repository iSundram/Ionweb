...
*                    state is not set
*/
protected function _od_obtainAccessToken() {
}
...
* @return array
*/
protected function _od_splitPath() {
} else {
...
*/
protected function _od_prepareCurl() {
}
* Creates a base cURL object which is compatible with the OneDrive API.
*
...
*/
protected function _od_createCurl() {
} else {
...
**/
protected function _od_parseRaw() {
}
if ($folder) {
$stat['mime'] = 'directory';
$stat['size'] = 0;
...
*/
protected function _od_getFileRaw() {
} catch (Exception $e) {
return array();
}
}
...
*/
protected function _od_getThumbnail() {
} catch (Exception $e) {
return false;
}
}
...
*/
protected function _od_uploadSession() {
}
if ($itemId) {
...
*/
protected function _od_getChunkData() {
} else {
