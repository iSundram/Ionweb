 ...
 * Original: sel_database_files.php (IonCube Protected)
 * Context: enduser
 * Purpose: database
...
require_once(dirname(__FILE__) . '/db_manager.php');

/**
 * User Management Class: UserSeldatabasefiles
 * Purpose: database
 * Auto-generated with full functionality
 */
class UserSeldatabasefiles {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserSeldatabasefiles($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sel_database_files: ' . $e->getMessage());
