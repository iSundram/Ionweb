 ...
 * Original: rebuild_emps.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Rebuildemps
 * Purpose: general
...
try {
    $handler = new Rebuildemps($_POST['config'] ?? []);
    ...
    error_log('Error in rebuild_emps: ' . $e->getMessage());
