 ...
 * Original: pass_protect_dir.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserPassprotectdir
 * Purpose: general
 * Auto-generated with full functionality
 */
class UserPassprotectdir {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserPassprotectdir($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in pass_protect_dir: ' . $e->getMessage());
