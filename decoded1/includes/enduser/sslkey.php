 ...
 * Original: sslkey.php (IonCube Protected)
 * Context: enduser
 * Purpose: ssl
...
/**
 * User Management Class: UserSslkey
 * Purpose: ssl
...
try {
    ...
    $user = new UserSslkey($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sslkey: ' . $e->getMessage());
