 ...
 * Original: login_logs.php (IonCube Protected)
 * Context: enduser
 * Purpose: login
...
/**
 * User Management Class: UserLoginlogs
 * Purpose: login
...
try {
    ...
    $user = new UserLoginlogs($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in login_logs: ' . $e->getMessage());
