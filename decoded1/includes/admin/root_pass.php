 ...
 * Original: root_pass.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminRootpass
 * Purpose: general
...
try {
    ...
    $admin = new AdminRootpass($_POST['config'] ?? []);
    ...
    error_log('Error in root_pass: ' . $e->getMessage());
