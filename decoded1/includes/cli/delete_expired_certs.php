 ...
 * Original: delete_expired_certs.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Deleteexpiredcerts
 * Purpose: general
 * Auto-generated with intelligent functionality
 */
class Deleteexpiredcerts {
    private $config = [];
...
try {
    $handler = new Deleteexpiredcerts($_POST['config'] ?? []);
    ...
    error_log('Error in delete_expired_certs: ' . $e->getMessage());
