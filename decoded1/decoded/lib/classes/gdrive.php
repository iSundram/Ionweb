...
class gdrive{
	...
	function dir_opendir($path, $options){
		...
		$url = "https://www.googleapis.com/drive/v3/files?q='".$dir_id."'+in+parents&fields=files(name)&pageSize=1000";
		...
		if(preg_match('/w/is', $this->mode)){
			...
			if($this->tmpsize > 0){
				...
				if(!empty($this->complete)){
					$error[] = __('There were some errors while committing backup to your Google Drive account!!');
					return false;
				}
