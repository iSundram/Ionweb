 ...
 * Original: includes/admin/adminindex.php
 * Complexity: 20.6/100
 * Context: 
...
class CoreAdminAdminindex {
    ...
    public function authenticate() {
        ...
        $this->logger->info('Executing authenticate');
    ...
    public function authorize() {
        ...
        $this->logger->info('Executing authorize');
    ...
    public function manage() {
        ...
        $this->logger->info('Executing manage');
...
$instance = new CoreAdminAdminindex();
$instance->execute();
