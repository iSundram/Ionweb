...
global $user, $globals, $theme, $softpanel, $WE, $error, $done, $eapps_list, $ports_in_use, $apps;

	softheader(__('List Application'));

	echo '
<style>
.active-icon,.inactive-icon,.restart-icon{font-size: 18px !important; cursor: pointer;}
