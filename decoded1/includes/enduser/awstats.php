 ...
 * Original: awstats.php (IonCube Protected)
 * Context: enduser
 * Purpose: statistics
...
/**
 * User Management Class: UserAwstats
 * Purpose: statistics
...
try {
    ...
    $user = new UserAwstats($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in awstats: ' . $e->getMessage());
