 ...
 * Original: import_export.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminImportexport
 * Purpose: general
...
try {
    ...
    $admin = new AdminImportexport($_POST['config'] ?? []);
    ...
    error_log('Error in import_export: ' . $e->getMessage());
