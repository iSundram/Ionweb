...
* @author Dmitry (dio) Levashov
**/
public function commandArgsList() {
} else {
$list = array();
}
return $list;
...
* @return bool
*/
public function updateNetVolumeOption() {
}
return false;
}
...
* @param string $id
*/
public function removeUrlContentSaveId() {
}
...
* @author Dmitry (dio) Levashov
*/
protected function saveNetVolumes() {
}
...
* @return bool
*/
protected function removeNetVolume() {
}
if ($res) {
...
* @author  Naoki Sawada
**/
protected function get_remote_contents() {
}
...
* @author Naoki Sawada
**/
protected function curl_get_contents() {
}
$ch = curl_init();
...
* @author Naoki Sawada
*/
protected function fsock_get_contents() {
}
...
* @author Naoki Sawada
*/
protected function parse_data_scheme() {
}
fclose($fp);
...
* @author Naoki Sawada
*/
private function checkChunkedFile() {
}
...
* @return boolean
*/
protected function toastErrorHandler() {
}
$toast = array();
...
* @author Naoki Sawada
**/
protected function getNetVolumeUniqueId() {
}
$ids = array();
...
* @author Naoki Sawada
**/
protected function ensureDirsRecursively() {
}
$res['stats'][] = $dir;
...
*/
public function setToastErrorHandler() {
} else {
...
* @return bool
*/
public static function isAnimationGif() {
}
$imgcnt = 0;
$fp = fopen($path, 'rb');
fread($fp, 4);
...
* @return bool
*/
public static function isAnimationPng() {
}
$fp = fopen($path, 'rb');
...
* @return bool
*/
public static function isSeekableStream() {
}
...
*/
public static function isSeekableUrl() {
}
return null;
}
...
* @return mixed|string
*/
public static function sessionDataEncode() {
}
return $var;
}
...
* @return bool|mixed
*/
public static function sessionDataDecode() {
} else {
$data = $var;
}
$chk = true;
...
* @throws elFinderAbortException
*/
public static function extendTimeLimit() {
}
if ($defLimit != 0) {
...
* @return number
*/
public static function getIniBytes() {
}
}
$val = trim($val, "bB \t\n\r\0");
...
* @return     number
*/
public static function xKilobyte() {
}
$val .= '000';
} else {
$val *= 1024;
...
* @author Naoki Sawada
*/
public static function getStreamByUrl() {
}
...
* @return array
*/
public static function splitFileExtention() {
})$/i', $name, $m)) {
...
*/
public static function getMemorySizeByImageInfo() {
}
* Auto expand memory for GD processing
*
* @param      array $imgInfos The image infos
*/
public static function expandMemoryForGD() {
}
...
*/
public static function filenameDecontaminate() {
}
...
* @author Alexey Sukhotin
*/
public static function procExec() {
}
}
}
if (!$allowed) {
...
* @return string
*/
protected static function getCmdOfBind() {
}
...
* @return string
*/
protected static function addSubToBindName() {
}
* Remove a file if connection is disconnected
*
* @param string $file
*/
public static function rmFileInDisconnected() {
}
