 ...
 * Original: sel_restore_files.php (IonCube Protected)
 * Context: enduser
 * Purpose: restore
...
/**
 * User Management Class: UserSelrestorefiles
 * Purpose: restore
 * Auto-generated with full functionality
 */
class UserSelrestorefiles {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserSelrestorefiles($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sel_restore_files: ' . $e->getMessage());
