 ...
 * Original: support_ticket.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminSupportticket
 * Purpose: general
...
try {
    ...
    $admin = new AdminSupportticket($_POST['config'] ?? []);
    ...
    error_log('Error in support_ticket: ' . $e->getMessage());
