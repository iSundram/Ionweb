 ...
 * Original: create_languages.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Createlanguages
 * Purpose: general
...
try {
    $handler = new Createlanguages($_POST['config'] ?? []);
    ...
    error_log('Error in create_languages: ' . $e->getMessage());
