...
global $globals, $theme, $softpanel, $WE, $error, $iapps, $done, $templates;

	softheader(__('Web Template Editor'));
...
<script>
function show_preview(action){
        $("#preview_"+action).show();
        $("#preview_"+action+"_close").on("click", function(){
          $("#preview_"+action).hide();
        });
