 ...
 * Original: domaininfo.php (IonCube Protected)
 * Context: include
 * Purpose: domains
...
/**
 * General Purpose Class: Domaininfo
 * Purpose: domains
...
try {
    $handler = new Domaininfo($_POST['config'] ?? []);
    ...
    error_log('Error in domaininfo: ' . $e->getMessage());
