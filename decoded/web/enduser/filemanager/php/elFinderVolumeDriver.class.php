...
* @author Naoki Sawada
**/
public function isUploadableByName() {
}
...
* @author Naoki Sawada
*/
public function getExtentionByMime() {
}
}
}
...
* @author Dmitry (dio) Levashov
**/
public function setMimesFilter() {
}
}
...
* @author Naoki Sawada
*/
public function getOptionsPlugin() {
} else {
...
* @author Dmitry (dio) Levashov
**/
public function commandDisabled() {
}
...
* @throws     Exception
*/
protected function remoteArchive() {
}
}
}
$this->rmdirRecursive($dir);
...
* @author Naoki Sawada
*/
public function getTempLinkInfo() {
...
* @throws elFinderAbortException
*/
public function getSubstituteImgLink() {
}
}
...
* @author Naoki Sawada
*/
public function getUploadTaget() {
} else {
return false;
}
} else {
...
public function setUploadOverwrite() {
}
* Image file utility
*
...
* @author Dmitry (dio) Levashov
*/
protected function nameAccepted() {
}
...
*/
public function mimeTypeNormalize() {
}
...
* @author Naoki Sawada
*/
protected function getWorkFile() {
}
...
* @author Naoki Sawada
*/
protected function getItemsInHand() {
}
if (is_null($dir)) {
$totalSize = 0;
if (!$tmpDir = $this->getTempPath()) {
...
* @return boolean
*/
protected function allowPutMime() {
...
* @return array
*/
protected function isNameExists() {
}
...
*/
static protected function loadMimeTypes() {
...
* @author Dmitry (dio) Levashov
**/
static protected function mimetypeInternalDetect() {
}
$ext = '';
if ($path) {
$pinfo = pathinfo($path);
...
* @author Dmitry (dio) Levashov
**/
protected function closestByAttr() {
}
...
* @author Dmitry (dio) Levashov
**/
protected function childsByAttr() {
}
}
return false;
}
protected function isMyReload() {
}
...
* @return void
*/
protected function updateSubdirsCache() {
} else {
...
* @author Dmitry (dio) Levashov
**/
protected function canCreateTmb() {
}
...
*/
protected function gdImageCreate() {
}
...
* @return bool
*/
protected function imagickImage() {
}
try {
if ($destformat) {
if ($destformat === 'gif') {
...
*/
protected function gdImageBackground() {
} else {
list($r, $g, $b) = sscanf($bgcolor, "#%02x%02x%02x");
...
* @throws elFinderAbortException
*/
protected function imageMagickConvertPrepare() {
}
if (is_null($mime)) {
...
*/
protected function searchMatchName() {
}
...
* @author Naoki Sawada
*/
protected function checkExtractItems() {
}
$chkSymlink = in_array('symlink', $checks) && $this->options['check_archive_symlinks'];
...
if (!is_readable($p) && !empty($this->options['check_archive_symlinks'])) {
...
* @author Naoki Sawada
*/
protected static function localScandir() {
}
}
closedir($dh);
} else {
...
* @author Naoki Sawada
*/
protected static function localRmdirRecursive() {
} else {
...
$original_perms = fileperms($src);
$temp_perms = is_dir($src) ? 0755 : 0644;
if (chmod($src, $temp_perms) && rename($src, $target)) {
chmod($target, $original_perms);
return true;
}
return false;
}
...
* @author Naoki Sawada
*/
protected static function localMoveRecursive() {
}
...
if ($del) {
return self::rename_file($src, $target);
}
}
} else {
...
* @author Naoki Sawada
*/
protected static function zipArchiveZip() {
}
} else {
$zip = $zipPath;
}
...
* @author Naoki Sawada
*/
protected static function zipArchiveUnzip() {
}
if (!$maxSize) {
...
* @author Dmitry (dio) Levashov
*/
protected static function localFindSymlinks() {
}
if (is_dir($path)) {
