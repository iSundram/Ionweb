 ...
 * Original: fix_user_dir.php (IonCube Protected)
 * Context: include
...
/**
 * General Purpose Class: Fixuserdir
 * Purpose: user_management
...
try {
    $handler = new Fixuserdir($_POST['config'] ?? []);
    ...
    error_log('Error in fix_user_dir: ' . $e->getMessage());
