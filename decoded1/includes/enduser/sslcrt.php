 ...
 * Original: sslcrt.php (IonCube Protected)
 * Context: enduser
 * Purpose: ssl
...
/**
 * User Management Class: UserSslcrt
 * Purpose: ssl
...
try {
    ...
    $user = new UserSslcrt($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sslcrt: ' . $e->getMessage());
