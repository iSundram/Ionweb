 ...
 * Original: class.webuzo.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Classwebuzo
 * Purpose: general
...
try {
    $handler = new Classwebuzo($_POST['config'] ?? []);
    ...
    error_log('Error in class.webuzo: ' . $e->getMessage());
