 ...
 * Original: compress_functions.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Compressfunctions
 * Purpose: general
...
try {
    $handler = new Compressfunctions($_POST['config'] ?? []);
    ...
    error_log('Error in compress_functions: ' . $e->getMessage());
