 ...
 * Original: delete_backups.php (IonCube Protected)
 * Context: include
 * Purpose: backup
...
/**
 * General Purpose Class: Deletebackups
 * Purpose: backup
...
try {
    $handler = new Deletebackups($_POST['config'] ?? []);
    ...
    error_log('Error in delete_backups: ' . $e->getMessage());
