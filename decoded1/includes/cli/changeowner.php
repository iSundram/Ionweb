 ...
 * Original: changeowner.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Changeowner
 * Purpose: general
...
try {
    $handler = new Changeowner($_POST['config'] ?? []);
    ...
    error_log('Error in changeowner: ' . $e->getMessage());
