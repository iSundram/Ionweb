 ...
 * Original: sel_email_files.php (IonCube Protected)
 * Context: enduser
 * Purpose: email
...
/**
 * User Management Class: UserSelemailfiles
 * Purpose: email
 * Auto-generated with full functionality
 */
class UserSelemailfiles {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserSelemailfiles($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sel_email_files: ' . $e->getMessage());
