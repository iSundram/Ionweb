 ...
 * Original: aliases.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserAliases
 * Purpose: general
...
try {
    ...
    $user = new UserAliases($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in aliases: ' . $e->getMessage());
