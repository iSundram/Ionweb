 ...
 * Original: download_file.php (IonCube Protected)
 * Context: include
...
/**
 * General Purpose Class: Downloadfile
 * Purpose: file_management
...
try {
    $handler = new Downloadfile($_POST['config'] ?? []);
    ...
    error_log('Error in download_file: ' . $e->getMessage());
