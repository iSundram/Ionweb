 ...
 * Original: mysql_functions.php (IonCube Protected)
 * Context: include
 * Purpose: database
...
/**
 * General Purpose Class: Mysqlfunctions
 * Purpose: database
...
try {
    $handler = new Mysqlfunctions($_POST['config'] ?? []);
    ...
    error_log('Error in mysql_functions: ' . $e->getMessage());
