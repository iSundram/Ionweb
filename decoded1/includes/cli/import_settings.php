 ...
 * Original: import_settings.php (IonCube Protected)
 * Context: include
 * Purpose: settings
...
/**
 * General Purpose Class: Importsettings
 * Purpose: settings
...
try {
    $handler = new Importsettings($_POST['config'] ?? []);
    ...
    error_log('Error in import_settings: ' . $e->getMessage());
