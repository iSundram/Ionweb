...
global $theme, $globals, $kernel, $user, $bandwidth, $done, $error, $year, $month, $type, $day, $domain, $colorcode, $prev_month, $next_month;	
...
<div class="card soft-card p-4 mt-4">';
	...
	if(!empty($day) && !empty($month) && !empty($year)){
		...
		// $xaxis = [[0, '12 am'], [1, '1 am'], [2, '2 am'], [3, '3 am'], [4, '4 am'], [5, '5 am'], [6, '6 am'], [7, '7 am'], [8, '8 am'], [9, '9 am'], [10, '10 am'], [11, '11 am'], [12, '12 pm'], [13, '1 pm'], [14, '2 pm'], [15, '3 pm'], [16, '4 pm'], [17, '5 pm'], [18, '6 pm'], [19, '7 pm'], [20, '8 pm'], [21, '9 pm'], [22, '10 pm'], [23, '11 pm']];
		for($i = 0; $i < 24; $i++){
			$xaxis[] = $i;
		}
	...
	// r_print(json_encode($yaxis, JSON_PRETTY_PRINT));
	// r_print(json_encode($xaxis, JSON_PRETTY_PRINT));
...
$(document).ready(function (){
	...
	// console.log(past_week_band, typeof past_week_band);
	// console.log(monthly_band, typeof monthly_band);
	...
	if(xaxis_data != null && xaxis_data.length > 0){
		...
		// console.log("data_set", typeof data_set, data_set, typeof type, type, xaxis_data);
		if(day){
	...
	// console.log("data_set_24", typeof data_set_24, data_set_24, typeof type, type, xaxis_data);
...
function getPrevMonth(){
 window.location.href = "'.$globals['ind'].'act=bandwidth&month='.$prev_month['month'].'&year='.$prev_month['year'].'&type='.$type.'";
}

function getNextMonth(){
 window.location.href = "'.$globals['ind'].'act=bandwidth&month='.$next_month['month'].'&year='.$next_month['year'].'&type='.$type.'";
}
</script>';
