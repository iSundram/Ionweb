 ...
 * Original: errorlog.php (IonCube Protected)
 * Context: enduser
 * Purpose: logging
...
/**
 * User Management Class: UserErrorlog
 * Purpose: logging
...
try {
    ...
    $user = new UserErrorlog($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in errorlog: ' . $e->getMessage());
