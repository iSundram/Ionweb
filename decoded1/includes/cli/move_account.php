 ...
 * Original: move_account.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Moveaccount
 * Purpose: general
...
try {
    $handler = new Moveaccount($_POST['config'] ?? []);
    ...
    error_log('Error in move_account: ' . $e->getMessage());
