 ...
 * Original: hotlink_protect.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserHotlinkprotect
 * Purpose: general
 * Auto-generated with full functionality
 */
class UserHotlinkprotect {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserHotlinkprotect($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in hotlink_protect: ' . $e->getMessage());
