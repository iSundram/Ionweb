 ...
 * Original: reseller_resource_usage.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminResellerresourceusage
 * Purpose: general
 * Auto-generated with full functionality
 */
class AdminResellerresourceusage {
    private $config = [];
    private $database;
    private $permissions;
    private $validator;
...
try {
    ...
    $admin = new AdminResellerresourceusage($_POST['config'] ?? []);
    ...
    error_log('Error in reseller_resource_usage: ' . $e->getMessage());
