 ...
 * Original: admin_import_da.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Adminimportda
 * Purpose: general
...
try {
    $handler = new Adminimportda($_POST['config'] ?? []);
    ...
    error_log('Error in admin_import_da: ' . $e->getMessage());
