 ...
 * Original: two_factor_auth.php (IonCube Protected)
 * Context: enduser
...
/**
 * User Management Class: UserTwofactorauth
 * Purpose: authentication
...
try {
    ...
    $user = new UserTwofactorauth($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in two_factor_auth: ' . $e->getMessage());
