 ...
 * Original: modsec_rules.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminModsecrules
 * Purpose: general
 * Auto-generated with full functionality
 */
class AdminModsecrules {
    private $config = [];
    private $database;
    private $permissions;
    private $validator;
...
try {
    ...
    $admin = new AdminModsecrules($_POST['config'] ?? []);
    ...
    error_log('Error in modsec_rules: ' . $e->getMessage());
