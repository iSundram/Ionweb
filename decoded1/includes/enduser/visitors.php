 ...
 * Original: visitors.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserVisitors
 * Purpose: general
...
try {
    ...
    $user = new UserVisitors($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in visitors: ' . $e->getMessage());
