 ...
 * Original: disk_usage.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserDiskusage
 * Purpose: general
...
try {
    ...
    $user = new UserDiskusage($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in disk_usage: ' . $e->getMessage());
