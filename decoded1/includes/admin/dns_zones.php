 ...
 * Original: dns_zones.php (IonCube Protected)
 * Context: admin
 * Purpose: dns
...
/**
 * Admin Management Class: AdminDnszones
 * Purpose: dns
...
try {
    ...
    $admin = new AdminDnszones($_POST['config'] ?? []);
    ...
    error_log('Error in dns_zones: ' . $e->getMessage());
