...
/**
 * Advanced general Class: GeneralAddmodsecvendors
 * Purpose: create
 * Ultra-comprehensive with 50+ methods
 */
class GeneralAddmodsecvendors {
...
try {
    $handler = new GeneralAddmodsecvendors($_POST['config'] ?? []);
