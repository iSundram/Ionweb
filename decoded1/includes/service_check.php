 ...
 * Original: service_check.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Servicecheck
 * Purpose: general
...
try {
    $handler = new Servicecheck($_POST['config'] ?? []);
    ...
    error_log('Error in service_check: ' . $e->getMessage());
