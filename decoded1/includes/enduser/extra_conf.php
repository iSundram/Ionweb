 ...
 * Original: extra_conf.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserExtraconf
 * Purpose: general
...
try {
    ...
    $user = new UserExtraconf($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in extra_conf: ' . $e->getMessage());
