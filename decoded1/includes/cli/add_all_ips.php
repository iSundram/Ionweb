 ...
 * Original: add_all_ips.php (IonCube Protected)
 * Context: include
 * Purpose: general
...
/**
 * General Purpose Class: Addallips
 * Purpose: general
...
try {
    $handler = new Addallips($_POST['config'] ?? []);
    ...
    error_log('Error in add_all_ips: ' . $e->getMessage());
