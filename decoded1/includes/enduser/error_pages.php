 ...
 * Original: error_pages.php (IonCube Protected)
 * Context: enduser
 * Purpose: general
...
/**
 * User Management Class: UserErrorpages
 * Purpose: general
 * Auto-generated with full functionality
 */
class UserErrorpages {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserErrorpages($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in error_pages: ' . $e->getMessage());
