 ...
 * Original: add_plans.php (IonCube Protected)
 * Context: admin
 * Purpose: plans
...
/**
 * Admin Management Class: AdminAddplans
 * Purpose: plans
...
try {
    ...
    $admin = new AdminAddplans($_POST['config'] ?? []);
    ...
    error_log('Error in add_plans: ' . $e->getMessage());
