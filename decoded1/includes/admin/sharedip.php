 ...
 * Original: sharedip.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminSharedip
 * Purpose: general
...
try {
    ...
    $admin = new AdminSharedip($_POST['config'] ?? []);
    ...
    error_log('Error in sharedip: ' . $e->getMessage());
