 ...
 * Original: sel_cert_files.php (IonCube Protected)
 * Context: enduser
...
/**
 * User Management Class: UserSelcertfiles
 * Purpose: file_management
 * Auto-generated with full functionality
 */
class UserSelcertfiles {
    private $config = [];
    private $database;
    private $user_id;
    private $permissions;
...
try {
    ...
    $user = new UserSelcertfiles($_SESSION['user_id'], $_POST['config'] ?? []);
    ...
    error_log('Error in sel_cert_files: ' . $e->getMessage());
