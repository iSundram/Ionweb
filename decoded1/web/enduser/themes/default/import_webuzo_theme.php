...
<div class="card soft-card p-3 mb-4">
	<div class="sai_main_head">
		<img src="'.$theme['images'].'import_webuzo.png" alt="" class="webu_head_img me-2"/>
		<h5 class="d-inline-block">'.__('Import From Webuzo').'</h5>
	</div>
</div>
				...
				<div class="row mb-3">
					<div class="col-md-6 col-sm-12">
						...
						<label for="isbackup" class="sai_head control-label">'.__('I have a backup file (.tar.gz) saved in home directory').'
							<i class="fas fa-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="'.$l['exp_backup_avbl'].'"></i>
						</label><br />
						<div class="with-pass">
							<label for="r_domain" class="sai_head">'.__('Webuzo Server Address (Required)').'
							...
							<label for="r_pass" class="sai_head ">'.__('Password').'
								<i class="fas fa-info-circle ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="'.__('Webuzo user password. If specified, the process will import data directly from Remote Webuzo Server.').'"></i>
							</label>
						...
						<div id="backup" style="display:none;">
							<label for="r_backup" class="sai_head ">'.__('Webuzo backup file').'</label><br />
