 ...
 * Original: listapps.php (IonCube Protected)
 * Context: admin
 * Purpose: general
...
/**
 * Admin Management Class: AdminListapps
 * Purpose: general
...
try {
    ...
    $admin = new AdminListapps($_POST['config'] ?? []);
    ...
    error_log('Error in listapps: ' . $e->getMessage());
